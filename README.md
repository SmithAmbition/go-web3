...
[![Build Status](https://travis-ci.org/ethereum/go-web3.svg?branch=master)](https://travis-ci.org/ethereum/go-web3)
...
```bash
go get -u github.com/ethereum/go-web3
```

### glide

```bash
glide get github.com/ethereum/go-web3
```
